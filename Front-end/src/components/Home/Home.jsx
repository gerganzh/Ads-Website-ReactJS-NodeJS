...
//for the background image, as React.JS won't read it directly from the CSS
const imgMyimageexample = require('./images/image.jpg');
const divStyle = {
  height: "1000px",
...
class App extends Component {
    ...
    render() {
      //Using Helmet yet again, as normal CSS would not work
      return (
        ...
        <p className="title">WELCOME TO MY STUFF</p>
      </div>
      </div>
      );
    }
